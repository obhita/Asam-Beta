...
namespace Asam.Ppc.Primitives 
{
    ...
    public class PersonName : IPrimitive, IEquatable<PersonName>
    {
        ...
        public bool Equals ( PersonName other )
        {
            ...
            return Equals ( other.Suffix, Suffix ) && Equals ( other.LastName, LastName ) && Equals ( other.MiddleName, MiddleName ) && Equals ( other.FirstName, FirstName ) && Equals ( other.Prefix, Prefix );
        }
