<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Asam.Ppc.LocalSTS.Default" ValidateRequest="false" %>
...
<body>
    ...
    <div>
        ...
        <ul>
         ...
         Use more secure authentication mode for production scenarios.
    </div>
    </form>
</body>
</html>
