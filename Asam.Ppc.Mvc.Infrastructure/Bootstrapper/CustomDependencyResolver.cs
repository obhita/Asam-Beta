...
namespace Asam.Ppc.Mvc.Infrastructure.Bootstrapper
{
    public class CustomDependencyResolver :  IDependencyResolver, System.Web.Http.Dependencies.IDependencyResolver
    {
        ...
        /// <summary>
        /// Gets the service.
        /// Should return null when the service cannot be found <see cref="http://msdn.microsoft.com/en-us/library/system.web.mvc.idependencyresolver.getservice.aspx"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the services.
        /// Should return an empty collection when no service can be found <see cref="http://msdn.microsoft.com/en-us/library/system.web.mvc.idependencyresolver.getservices.aspx"/>. 
        /// </summary>
        /// <param name="serviceType">Type of the service.</param>
