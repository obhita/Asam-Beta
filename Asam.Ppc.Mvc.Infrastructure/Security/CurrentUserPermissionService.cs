namespace Asam.Ppc.Mvc.Infrastructure.Security
{
    ...
    public class CurrentUserPermissionService : ICurrentUserPermissionService
    {
        ...
        /// <returns>
        ///   <c>true</c> if the user has been granted the specified <see cref="Asam.Ppc.Mvc.Infrastructure.Permission"/>; otherwise, <c>false</c>.
        /// </returns>
        public bool DoesUserHavePermission(Permission permission)
        {
            ...
            var hasClaim = claimsIdentity.Claims.Any(
                                                     c =>
                                                     c.Type == AsamClaimTypes.PermissionClaimType && c.Value == permission.Name);
