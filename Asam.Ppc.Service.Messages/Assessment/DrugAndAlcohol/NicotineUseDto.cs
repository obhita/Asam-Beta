namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class NicotineUseDto : SectionDtoBase
    {
        ...
        [Display ( Order = 14 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "NicotineUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 8 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "NicotineUse_ThinkAboutHeader" )]
        ...
        [Display ( Order = 5 )]
        [Question ( QuestionType.ScriptedQuestion )]
        public LookupDto NicotineRouteOfIntake { get; set; }
        ...
        [Display ( Order = 25 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "NicotineUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 20 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "NicotineUse_SubstanceUseReductionHeader", "SixColumns" )]
