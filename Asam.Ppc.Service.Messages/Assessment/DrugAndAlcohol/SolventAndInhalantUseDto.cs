namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class SolventAndInhalantUseDto : SectionDtoBase
    {
        ...
        [Display ( Order = 12 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "SolventAndInhalantUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 6 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "SolventAndInhalantUse_ThinkAboutHeader" )]
        ...
        [Display ( Order = 23 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "SolventAndInhalantUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 18 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "SolventAndInhalantUse_SubstanceUseReductionHeader", "SixColumns" )]
