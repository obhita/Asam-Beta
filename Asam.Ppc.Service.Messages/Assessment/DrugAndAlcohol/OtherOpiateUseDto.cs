namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class OtherOpiateUseDto : SectionDtoBase
    {
        ...
        public bool? DocumentedEvidenceOfOpioidDependenceAtLeast1Year { get; set; }

        [Display ( Order = 28 )]
        [Question ( QuestionType.InterviewerQuestion )]
        public bool? EvidenceFromUrineScreenOfOpioidDependence { get; set; }
        ...
        [Display ( Order = 14 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "OtherOpiateUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 8 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "OtherOpiateUse_ThinkAboutHeader" )]
        ...
        public LookupDto OpioidRelapseLikelyIndicator { get; set; }
        ...
        [Display ( Order = 25 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "OtherOpiateUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 20 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "OtherOpiateUse_SubstanceUseReductionHeader", "SixColumns" )]
        ...
        [Display(Order = 7)]
        [Question(QuestionType.ScriptedQuestion)]
        public bool? ReceivingOngoingMaintenanceTherapy { get; set; }
