namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class StimulantUseDto : SectionDtoBase
    {
        ...
        [Display ( Order = 14 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "StimulantUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 8 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "StimulantUse_ThinkAboutHeader" )]
        ...
        [Display ( Order = 25 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "StimulantUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 20 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "StimulantUse_SubstanceUseReductionHeader", "SixColumns" )]
