namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class HallucinogenUseDto : SectionDtoBase
    {
        ...
        [Display ( Order = 12 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "HallucinogenUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 6 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "HallucinogenUse_ThinkAboutHeader" )]
        ...
        [Display ( Order = 23 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "HallucinogenUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 18 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "HallucinogenUse_SubstanceUseReductionHeader", "SixColumns" )]
