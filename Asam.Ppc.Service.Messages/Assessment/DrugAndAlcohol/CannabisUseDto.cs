namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class CannabisUseDto : SectionDtoBase
    {
        ...
        [Display ( Order = 14 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "CannabisUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 8 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "CannabisUse_ThinkAboutHeader" )]
        ...
        [Display ( Order = 25 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "CannabisUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 20 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "CannabisUse_SubstanceUseReductionHeader", "SixColumns" )]
