namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class MethadoneUseDto : SectionDtoBase
    {
        ...
        [Display ( Order = 14 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "MethadoneUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 8 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "MethadoneUse_ThinkAboutHeader" )]
        ...
        [Display ( Order = 25 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "MethadoneUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 20 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "MethadoneUse_SubstanceUseReductionHeader", "SixColumns" )]
