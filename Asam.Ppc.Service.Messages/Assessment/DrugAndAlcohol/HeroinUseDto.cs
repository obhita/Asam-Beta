namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class HeroinUseDto : SectionDtoBase
    {
        ...
        [Display ( Order = 12 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "HeroinUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 6 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "HeroinUse_ThinkAboutHeader" )]
        ...
        [Display ( Order = 23 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "HeroinUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 18 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "HeroinUse_SubstanceUseReductionHeader", "SixColumns" )]
