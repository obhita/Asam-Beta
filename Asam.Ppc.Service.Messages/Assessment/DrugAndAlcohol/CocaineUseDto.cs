namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class CocaineUseDto : SectionDtoBase
    {
        ...
        [Display ( Order = 12 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "CocaineUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 6 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "CocaineUse_ThinkAboutHeader" )]
        ...
        [Display ( Order = 23 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "CocaineUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 18 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "CocaineUse_SubstanceUseReductionHeader", "SixColumns" )]
