namespace Asam.Ppc.Service.Messages.Assessment.DrugAndAlcohol
{
    ...
    public class OtherSubstanceUseDto : SectionDtoBase
    {
        ...
        [Display ( Order = 15 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "OtherSubstanceUse_FrequentlyHighHeader", "SixColumns" )]
        ...
        [Display ( Order = 9 )]
        [Question ( QuestionType.ScriptedQuestion )]
        [QuestionGroup ( "OtherSubstanceUse_ThinkAboutHeader" )]
        ...
        [Display ( Order = 26 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "OtherSubstanceUse_SubstanceUseRecurrentProblemsHeader", "SixColumns" )]
        ...
        [Display ( Order = 21 )]
        [Question ( QuestionType.GeneralQuestion )]
        [QuestionGroup ( "OtherSubstanceUse_SubstanceUseReductionHeader", "SixColumns" )]
