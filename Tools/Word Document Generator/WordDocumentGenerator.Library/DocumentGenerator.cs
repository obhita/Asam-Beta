...
namespace WordDocumentGenerator.Library
{
    ...
    public abstract class DocumentGenerator
    {
        ...
        protected void SetBackgroundColorOfTableCell(SdtElement element)
        {
            // Set table cell background ( shading)
            this.openXmlHelper.SetBackgroundColorOfTableCell(element);
        }

        protected void MakeContentHyperlink(SdtElement element, string location)
        {
            // Set text without data binding
            this.openXmlHelper.MakeContentHyperlink(element, location);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public byte[] GenerateDocument(bool removeContentControls = false)
        {
            ...
            return SetContentInPlaceholders(removeContentControls);
        }
        ...
        /// </summary>
        /// <returns></returns>
        private byte[] SetContentInPlaceholders(bool removeContentControls = false)
        {
            byte[] output = null;
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                using (WordprocessingDocument wordDocument = WordprocessingDocument.Open(ms, true))
                {
                    ...
                    {
                        this.openXmlHelper.RemoveContentControlsAndKeepContents ( document );
                    }
