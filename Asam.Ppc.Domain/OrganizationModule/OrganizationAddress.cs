namespace Asam.Ppc.Domain.OrganizationModule
{
    ...
    /// </summary>
    public class OrganizationAddress : Entity, IEquatable<OrganizationAddress>
    {
        ...
        /// </value>
        public virtual OrganizationAddressType OrganizationAddressType { get; protected set; }
        ...
        /// <returns></returns>
        public virtual bool Equals(OrganizationAddress other)
        {
